...
class TabModificarVehiculo(QWidget):
    ...
    def configurar_ui(self):
        ...
        # --- CAMPOS EDITABLES (SIN DUPLICADOS) ---
        self.mod_color = QComboBox()
        self.mod_color.addItems(cat.COLORES_VEHICULO)  # SOLO UNA VEZ
        self.mod_color.setCurrentIndex(-1)
        
        self.mod_estado = QComboBox()
        self.mod_estado.addItems(cat.ESTADOS_VEHICULO)  # SOLO UNA VEZ
    ...
    def procesar_actualizacion(self):
        ...
        exito, mensaje = GestorVehiculos.actualizar_vehiculo(
            vin_objetivo, nuevo_color, nuevo_estado, self.usuario_actual.id_usuario
        )
