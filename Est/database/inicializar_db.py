...
def crear_tablas():
    ...
    # 3. Tabla Propietarios (MODIFICADA con UNIQUE en teléfono y correo)
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS propietarios (
            ...
            direccion TEXT,
            telefono TEXT UNIQUE,  -- <-- AGREGADO UNIQUE
            correo_electronico TEXT UNIQUE,  -- <-- AGREGADO UNIQUE
    ...
    # 6. TABLA DE BITÁCORA DE AUDITORÍA
    cursor.execute('''
