...
class GestorPropietarios:
    ...
    def registrar_propietario(propietario):
        ...
        existe_telefono, msj_telefono = Validador.verificar_telefono_existe(propietario.telefono)
        if existe_telefono:
            return False, "Error: El número de teléfono ya está registrado por otro propietario."
        
        # Verificar correo duplicado
        existe_correo, msj_correo = Validador.verificar_correo_existe(propietario.correo_electronico)
        if existe_correo:
            return False, "Error: El correo electrónico ya está registrado por otro propietario."
        ...
        try:
            ...
            if 'curp' in error_str:
                ...
                return False, "Error: El número de teléfono ya está registrado por otro propietario."
            elif 'correo_electronico' in error_str:
                return False, "Error: El correo electrónico ya está registrado por otro propietario."
            else:
    ...
    def modificar_propietario(id_propietario, nueva_direccion, nuevo_telefono, nuevo_correo, nuevo_estado_licencia, nuevo_estado, id_usuario):
        ...
        # ===== VALIDACIONES DE DUPLICADOS AL MODIFICAR =====
        # Verificar teléfono duplicado (excluyendo el propietario actual)
        existe_telefono, msj_telefono = Validador.verificar_telefono_existe(nuevo_telefono, id_propietario)
        if existe_telefono:
            return False, "Error: El número de teléfono ya está registrado por otro propietario."
        
        # Verificar correo duplicado (excluyendo el propietario actual)
        existe_correo, msj_correo = Validador.verificar_correo_existe(nuevo_correo, id_propietario)
        if existe_correo:
            return False, "Error: El correo electrónico ya está registrado por otro propietario."
